...
| Pool-MC `n_tournaments` | `20000` (cross-seed stable at 20K with team-identity scoring; Spearman ρ=0.80, Jaccard=0.52 — MARGINAL, up from UNSTABLE at 5K Jaccard=0.19/Spearman=0.51) | `src/simulation/pool_competition.py:93`; `tests/test_pool_competition.py::TestRankStability`; `tests/test_pool_competition.py::TestCrossSeedRankStability`; `artifacts/rank_stability_check_20k_ti_2026-04-19.json` |
