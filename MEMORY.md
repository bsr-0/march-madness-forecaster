...
| P(1st) ranking is calibrated vs actual outcomes | **Original (2026-04-13, shape-encoded):** mean Spearman ρ = +0.37 across 14 years (2011-2025 ex 2020); t-test p=0.002; 12/14 years positive. **Amended (2026-04-17 per §2 O26-G1 rerun):** under real ESPN team-identity scoring, mean ρ = **+0.61** across 15 years (2011-2026 ex 2020), median +0.69, **100% of years positive** (15/15), two-sided t-test t=+8.53 p<1e-6 (shape companion t=+3.55 p=0.003). The shape-encoded baseline was internally consistent but materially UNDER-stated the real signal: P(1st) has stronger predictive power for actual pool placement than the closure originally claimed. Closes §2 O6; partially supersedes the "14% variance / 86% noise" framing cited in §3 row 53. Drift guard (`tests/test_pool_optimizer_calibration.py`) still checks the shape-encoded artifact as a regression anchor. | `artifacts/o6_winner_rank_diagnostic.json` (shape, original); `artifacts/o26_g1_full_14yr_rerun_2026-04-17.json` (team-identity, amendment); `tests/test_pool_optimizer_calibration.py`; `COUNCIL_LESSONS.md` §2 O6 + §2 O26 |
