...
DIFF_FEATURE_NAMES = [
    ...
    'top5_minutes_share',
    'preseason_ap_rank',
    'coach_tournament_exp', 'coach_tournament_win_rate', 'coach_postseason_score',
...
ABS_FEATURE_NAMES = [
    'avg_adj_off_eff', 'avg_adj_def_eff', 'avg_sos_adj_em',
    'avg_elo_rating', 'avg_win_pct',
]  # [86:91]

INTERACTION_FEATURE_NAMES = [
    'tempo_interaction', 'style_mismatch', 'seed_em_residual_diff',
    'sos_seed_interaction', 'three_pt_var_seed_int',
    'seed_interaction', 'seed_diff',
]  # [91:98]

ALL_FEATURE_NAMES = (
    ['diff_' + n for n in DIFF_FEATURE_NAMES]
    + ABS_FEATURE_NAMES
    + INTERACTION_FEATURE_NAMES
)
...
FEATURE_GROUPS = {
    ...
    'resume': [30, 31, 32, 48, 50, 61, 65, 66, 68],  # luck, sor, wab, win_pct, q1, best_win, conf_champ, neutral, tourn_resume
    'momentum': [33],
...
def run_analysis():
    ...
    full_brier, full_bss, full_folds = _run_loyo_subset(
        rs_cache, tourney_cache, list(range(98)), seed_briers,
    )
    print("=" * 74)
    ...
    for step in range(min(15, 98)):  # Stop at 15 features
        ...
        print(f"{step+1:>4} {ALL_FEATURE_NAMES[best_candidate]:>35} {best_candidate_brier:>8.4f} {best_candidate_bss:>+8.4f} {delta:>+8.4f}")
