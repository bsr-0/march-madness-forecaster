...
class LogisticTuner:
    ...
    - l1_ratio: [0.0, 1.0] (0=L2, 1=L1, between=elasticnet)
    """
    ...
    def tune(
        ...
        def objective(trial: optuna.Trial) -> float:
            ...
            # l1_ratio: 0=L2, 1=L1, between=elasticnet (replaces deprecated penalty param)
            l1_ratio = trial.suggest_float("l1_ratio", 0.0, 1.0)
            # saga solver required for l1_ratio support
            solver = "saga"
